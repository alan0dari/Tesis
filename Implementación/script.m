...
scatter(DM(indice_gra3,1),DM(indice_gra3,2),'s','MarkerEdgeColor','r','MarkerFaceColor','r','LineWidth',1.5);
scatter(DM(indice_codas3,1),DM(indice_codas3,2),'d','MarkerEdgeColor','m','MarkerFaceColor','m','LineWidth',1.5);
scatter(DM(indice_mabac3,1),DM(indice_mabac3,2),'^','MarkerEdgeColor','c','MarkerFaceColor','c','LineWidth',1.5);
scatter(DM(indice_vikor3,1),DM(indice_vikor3,2),'s','MarkerEdgeColor','k','MarkerFaceColor','k','LineWidth',1.5);
scatter(DM(indice_promethee3,1),DM(indice_promethee3,2),'d','MarkerEdgeColor','r','MarkerFaceColor','b','LineWidth',1.5);
xlabel('Entropía');
ylabel('SSIM');
legend({'Frente Pareto', 'Selección SMARTER', 'Selección Fuzzy', 'Selección TOPSIS', 'Selección GRA', 'Selección CODAS', 'Selección MABAC', 'Selección VIKOR', 'Selección PROMETHEE II'})
...
T = table([Pareto(indice_smarter1,:);Pareto(indice_fuzzy1,:);Pareto(indice_topsis1,:);Pareto(indice_gra1,:);Pareto(indice_codas1,:);Pareto(indice_mabac1,:);Pareto(indice_vikor1,:);Pareto(indice_promethee1,:)]);
writetable(T, strcat(path,'decisiones_w1.xlsx'), 'Sheet',1,'Range','A1:H3000')

T = table([Pareto(indice_smarter2,:);Pareto(indice_fuzzy2,:);Pareto(indice_topsis2,:);Pareto(indice_gra2,:);Pareto(indice_codas2,:);Pareto(indice_mabac2,:);Pareto(indice_vikor2,:);Pareto(indice_promethee2,:)]);
writetable(T, strcat(path,'decisiones_w2.xlsx'), 'Sheet',1,'Range','A1:H3000')

T = table([Pareto(indice_smarter3,:);Pareto(indice_fuzzy3,:);Pareto(indice_topsis3,:);Pareto(indice_gra3,:);Pareto(indice_codas3,:);Pareto(indice_mabac3,:);Pareto(indice_vikor3,:);Pareto(indice_promethee3,:)]);
